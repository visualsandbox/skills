...
- **Audio** (async, 5–30s): `audio/elevenlabs-sound-fx`, `audio/elevenlabs-tts` (text to speech, 21 stock voices), `audio/eleven-music`, `audio/minimax-music-2.6` (a full song, one flat price), `audio/minimax-music-cover` (re-sing a recording), `audio/scribe` (speech to text)
